...
def carregar_dados():
    if not os.path.exists(DB_PATH):
        df = pd.DataFrame(columns=[
            ...
            "aprovador", "data", "hora_aprovacao", "motivo_reprovacao", "impresso"
        ])
...
if menu == "Painel Admin":
    ...
    novo_perfil = st.selectbox("Perfil:", ["mercadinho", "almoxarifado", "mercadinho e almoxarifado"])

    if st.button("Salvar Novo Usuário"):
        st.session_state.usuarios[novo_user] = {"senha": nova_senha, "perfil": novo_perfil}
